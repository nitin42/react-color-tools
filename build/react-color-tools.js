...
var Container = function Container(_ref) {
  ...
  return React__default.createElement(
    'div',
    {
      className: emotion.css(_templateObject$2, width, height, background)
    },
    children
  )
}
...
var StyledIcon = styled__default('i')(_templateObject$8, function(props) {
  return props.color
})

var StyledSpan = styled__default('span')(_templateObject2$2)

var ToolsIcon = styled__default('i')(_templateObject3, function(props) {
  return props.color
})

var StyledLabel = styled__default('label')(_templateObject4, function(props) {
  return props.color
})
...
var HOC = function HOC(Comp) {
  return function(props) {
    return React__default.createElement(Consumer, null, function(color) {
      return React__default.createElement(
        Comp,
        _extends({ color: color }, props)
      )
    })
  }
}
...
var ColorSaturator = HOC(function(_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(StyledLabel, { color: color }, value)
  )
})
...
var ColorSpinner = HOC(function(_ref5) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      { color: color },
      value,
      React__default.createElement('sup', null, '\xB0')
    )
  )
})
...
var ImagePicker = HOC(function(_ref6) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(ToolsIcon, {
      id: 'image-icon',
...
var StyledList = styled__default('ul')(_templateObject$9)

var ToolsContainer = styled__default('div')(
  _templateObject2$3,
  function(props) {
...
var BasicPicker = (function(_React$PureComponent) {
  ...
  BasicPicker.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      image === null
        ? React__default.createElement(ColorBlock, {
      ...
      image &&
        React__default.createElement(reactColorExtractor.ColorExtractor, {
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ToolsContainer,
            null,
            React__default.createElement(BasicTools.ImagePicker, {
              uploadImage: this.uploadImage
            }),
            React__default.createElement(BasicTools.PaletteGenerator, {
              generateSwatches: this.generateSwatches
            }),
            React__default.createElement(BasicTools.TintsGenerator, {
            ...
            React__default.createElement(BasicTools.Reset, {
...
var StyledLabel$1 = styled__default('label')(_templateObject$a, function(
  props
) {
  return props.color
})
...
var ColorBlock$1 = function ColorBlock(_ref) {
  ...
  return React__default.createElement('div', {
    className: styled.css(_templateObject2$4),
...
var Swatch$1 = function Swatch(_ref) {
  var color = _ref.color,
    updateSwatch = _ref.updateSwatch
  return React__default.createElement('div', {
    className: emotion.css(_templateObject$b, color),
...
var CompactSwatches = function CompactSwatches(_ref2) {
  ...
  return React__default.createElement(
    'div',
    {
      className: emotion.css(_templateObject2$5)
    },
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'div',
            {
              className: emotion.css(_templateObject$c)
            },
            React__default.createElement(BasicTools.Clipboard, {
