...
export const SaturatorIcon = ({ width, height, color }) => (
  <StyledSVG width={width} height={height} viewBox="0 0 24 24">
    <title>Color Saturator</title>
    <path
      fill={color}
...
export const DesaturatorIcon = ({ width, height, color }) => (
  <StyledSVG width={width} height={height} viewBox="0 0 26 28">
    <title>Color Desaturator</title>
    <path
      fill={color}
...
export const ColorSpinIcon = ({ width, height, color }) => (
  <StyledSVG width={width} height={height} viewBox="0 0 24 28">
